# 🚀 WOT Blitz Cluster Selector | Лагам — нет! 🎮
...
1. Скачайте программу через [Релиз ссылку](https://github.com/scopeech/wotblitz_cluster_selector_WG/releases/tag/v0.0.5).
